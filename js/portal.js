...
function mostrarPortal(){
    ...
    <section class="portal">
        ...
        <p class="portalTexto">
        Todo héroe tiene una historia.<br>
        ¿Quién cruzará el portal?
        </p>

        <div id="listaPerfiles"></div>

        <button
        class="btnNuevoPerfil"
        onclick="mostrarCrearPerfil()">
...
function cargarTarjetasPerfiles(){
    ...
    for(const id in perfiles){
        ...
        <div class="cardPerfil">
            ...
            <img
            src="images/characters/${jugador.avatar}"
            class="avatarPerfil">
...
function mostrarCrearPerfil(){
    ...
    <div class="avatarCard seleccionado"
         onclick="seleccionarAvatar('explorer.jpg',this)">
    ...
    <div class="avatarCard"
         onclick="seleccionarAvatar('alien.jpg',this)">
    ...
    <div class="avatarCard"
         onclick="seleccionarAvatar('dwarf.jpg',this)">
    ...
    <div class="avatarCard"
         onclick="seleccionarAvatar('elf.jpg',this)">
    ...
    <div class="avatarCard"
         onclick="seleccionarAvatar('witch.jpg',this)">
    ...
    <div class="avatarCard"
         onclick="seleccionarAvatar('wolf.jpg',this)">
        ...
        <button onclick="crearNuevoPerfil()">
            ⚔️ Comenzar aventura
        </button>
